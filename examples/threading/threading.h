...
struct thread_data{
     ...
     */
     ...
     pthread_mutex_t *mutex; //mutex needed for thread implementation
     int wait_to_obtain_ms; //Requested wait time before obtaining mutex
     int wait_to_release_ms; //Requested wait time before releasing mutex
